...
public class Stage02 extends Stage {
	...
	public void stageStarted() {
		...
		// player
		Game.timelines.add(new TimeLine(5, "player", CONST_OF_TILE_X + Game.MS * 2, CONST_OF_TILE_Y + Game.MS * 6,
		...
		Game.timelines.add(new TimeLine(2, "directionpad", CONST_OF_TILE_X + Game.MS * 9, CONST_OF_TILE_Y + Game.MS,
